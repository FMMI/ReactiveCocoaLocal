...
extension Reactive where Base: NSObjectProtocol {
	...
	public func associatedValue<T>(forKey key: StaticString = #function, initial: (Base) -> T) -> T {
...
public func unsafeSetAssociatedValue<Value>(_ value: Value?, forKey key: AssociationKey<Value>, forObjectAt address: UnsafeRawPointer) {
